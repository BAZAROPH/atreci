                ...
                <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
                    <div class="d-flex flex-wrap">
                        <form method="GET" class="form-inline flex-nowrap mr-3 mr-sm-4 pb-3">
                            ...
                            @php($array = listing_post($parametre->type_id, $categorie_id, $apparence_id = null, $limit = 60, $column = 'col-md-4 col-sm-6', $post_id = null, $nCaractere = null, $champATrier = 'id desc', $typeImage = 'thumb', $page = 'category'))
