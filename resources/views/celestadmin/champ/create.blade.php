                                ...
                                <div class="md-float-material">
                                    <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="md-input-wrapper">
                                                <select id="type_champ_id" class="md-form-control" name="type_champ_id" required>
                                                    ...
                                                    @foreach ($type_valeurs as $type_valeur)
                                                        <option value="{{ $type_valeur->id }}" {{ ( $type_valeur->id == old('type_champ_id')) ? 'selected' : '' }}>
                                                            {{ $type_valeur->libelle }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="md-input-wrapper has-success">
                                                ...
                                                <div id="visible" class="radio radiofill form-radio m-0">
                                                    <label class="d-inline-block m-r-10">
                                                        <input checked type="radio" value="1" name="visible" data-bv-field="visible">Oui<i class="helper"></i>
                                                    </label>
                                                    <label class="d-inline-block">
                                                        <input type="radio" name="visible" value="" data-bv-field="visible">Non<i class="helper"></i>
                                                    </label>
                                                    <span class="messages"></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="md-group-add-on p-relative">
                                            ...
                                            <div class="md-input-wrapper">
                                                <input id="titre" name="titre" value="{{ old('titre') }}" type="text" class="md-form-control">
                                        ...
                                        <div class="md-group-add-on p-relative">
                                            ...
                                            <div class="md-input-wrapper">
                                                <textarea style="display: none;" id="requete" name="requete" class="md-form-control">{{ old('requete') }}</textarea>
                                        ...
                                        <div id="editor">{{--  Categorie::where(['taxonomie_id' => 11])->orderBy('libelle', 'asc')->get()  --}}</div>
