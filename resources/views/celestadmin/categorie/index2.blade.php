                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($valeur->getMedia('image')->first()))
                                                        <img width="60" src="{{ url($valeur->getMedia('image')->first()->getUrl('thumb')) }}">
                                                    @else
                                                        <img width="60" src="{{ asset('admin/image/no-image.png') }}">
                                                    @endif
                                                ...
                                                @if ($infosPage['slug'] == 'rubrique')
                                                    ...
                                                    <td>
                                                        @if(!empty($valeur->apparences[0]->getMedia('image')->first()))
                                                            <img height="40" src="{{ url($valeur->apparences[0]->getMedia('image')->first()->getUrl('thumb')) }}">
                                                        @endif
                                                        {{ $valeur->apparences[0]->libelle }}
                                                    </td>
                                                @endif
                                                <td>
